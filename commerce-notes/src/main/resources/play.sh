#!/bin/bash
JDK_HOME="/Library/Java/JavaVirtualMachines/jdk-11.0.10.jdk/Contents/Home/bin/java"
VM_OPTS="-Xmx2048m -Xms2048m"
SPB_OPTS="--spring.profiles.active=dev"
APP_LOCATION="/Users/qgs/IdeaProjects/springcloud-commerce/commerce-admin/target/commerce-admin-1.0-SNAPSHOT.jar"
APP_NAME="commerce-admin"
