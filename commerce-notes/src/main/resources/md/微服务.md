...
java -jar zipkin-server-2.21.7-exec.jar --STORAGE_TYPE=mysql --MYSOL_HOST=127.0.0.1 --MYSQL_TCP_PORT=3306 --MYSQL_USER=root --MYSQL_PASS=root --MYSQL_DB=imooc_zipkin
