...
```sh
java -Dserver.port=7777 -Dcsp.sentinel.dashboard.server=localhost:7777 -Dproject.name=sentinel-dashboard -jar sentinel-dashboard-1.8.1.jar
```
...
```sh
# s添加 gateway 支持
java -Dserver.port=7777 -Dcsp.sentinel.app.type=1 -Dcsp.sentinel.dashboard.server=localhost:7777 -Dproject.name=gateway-sentinel-dashboard -jar sentinel-dashboard-1.8.1.jar
```
